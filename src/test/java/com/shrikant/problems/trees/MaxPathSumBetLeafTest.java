...
public class MaxPathSumBetLeafTest {
    MaxPathSumBetLeaf testObj;

    private String input;
    private int expectedOutput;

    public MaxPathSumBetLeafTest(String input, int expectedOutput)
    {
        this.input = input;
   ...
   public void testConvertToDLL() {
       ...
       assertThat(testObj.getMaxPathSumBetLeaf(root), is(expectedOutput));
   }
}
