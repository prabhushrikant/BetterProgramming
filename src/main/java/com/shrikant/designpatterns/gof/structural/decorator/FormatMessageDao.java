...
public class FormatMessageDao extends AbstractDecorator {
  ...
  public FormatMessageDao(IMessageDao messageDao) {
    super(messageDao);
  }
  ...
  public Message formatMessage(Message srcMessage, String css) {
    ...
    //todo:
    //deep copy message.
    Message copyOfMessage = new Message(UUID.randomUUID(), srcMessage.title, srcMessage.body, srcMessage.signature);
  ...
  public void decorate() {
    ...
    LOGGER.info("Decorate method called in FormatMessageDao.");
  }
}
